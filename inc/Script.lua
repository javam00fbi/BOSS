...
if not SudoBase() then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local GetVerison = https.request('https://th3boss.com/GetVersion.txt') or 0
...
if msg.type == "pv" then -- ارسال الرساله بالخاص عبر رد على التوجيه
...
elseif redis:get(boss..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
